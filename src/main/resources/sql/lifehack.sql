...
INSERT INTO public.ss_brand (name) VALUES
                                       ('Ben & Jerrys'),
                                       ('Premier'),
                                       ('Frisko'),
                                       ('Gudhjemis'),
...
INSERT INTO public.ss_ice_cream (name, brand_id, description) VALUES
                                                                  ('Caramel Brownie Party', 1, 'The best ice cream on the market - it is a caramel ice cream with caramel sauce swirls and gooey brownie chunks. It is addictive! - Absolutely S-tier'),
                                                                  ('Cookie Dough Swich Up', 1, 'Vanilla ice cream with cocoa cookies, pieces of cookie dough with chocolate pieces, and swirl of cocoa cookies'),
                                                                  ('Skildpaddeis', 2, 'Rum flavored ice cream with 16% caramel sauce and 10% chocolate pieces. Absolutely S-tier. Try it with bananas!'),
                                                                  ('Lemon sorbet', 4, 'Lemon flavored sorbet ice cream - Recommended by Christoffer'),
                                                                  ('Cookie dough deluxe', 5, 'Vegan vanilla ice cream with chocolate chip cookie dough chunks and chocolate pieces. - Good vegan alternative to Rema1000s or Ben & Jerrys'),
                                                                  ...
                                                                  ('Magnum Double White Chocolate & Cookies', 4, 'Vanilla ice cream with white chocolate chunks, chocolate cookie-crumblesauce and a thick layer of white chocolate on top'),
...
INSERT INTO public.ss_rank_list (user_id, title) VALUES
                                                     (1, 'Daniels liste'),
                                                     (2, 'Rikkes liste');

INSERT INTO public.ss_rank_list_item (id, rank_list_id, ice_cream_id, tier, position) VALUES
    (1, 1, 1, 'S', 1);
